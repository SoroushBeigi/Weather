...
setup() {
  ...
  //use cases
  locator.registerSingleton<GetWeatherUseCase>(GetWeatherUseCase(weatherRepository: locator()));

  //blocs
  locator.registerSingleton<WeatherBloc>(WeatherBloc(getWeatherUseCase: locator()));
}
